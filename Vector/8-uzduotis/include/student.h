...
{
private:
    MyVector<int> _paz; /**< Studento pazymiai */
...
public:
     ...
     * @return Studento pazymius MyVector<int>
     */
    inline const MyVector<int>& paz() const { return _paz; }
    /**
     ...
     */
    void AddPaz(int paz) { _paz.PushBack(paz); }
    /**
