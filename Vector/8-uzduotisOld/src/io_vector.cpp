...
void duomenuIrasymasFaile(const vector<Studentas>& grupe, int temp, const string& fileName)
{
...
void SplitStudentsStrategy1(const vector<Studentas>& grupe,
